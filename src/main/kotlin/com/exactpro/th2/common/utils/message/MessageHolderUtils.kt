...
val MessageHolder.sessionAlias: String?
    get() = id.sessionAlias

fun MessageHolder.getTreeTable(): TreeTable = when (this) {
    is ProtoMessageHolder -> source.toTreeTable()
    is TransportMessageHolder -> source.toTreeTable()
}